...
enum TrafficLight
{
	RED(20),YELLOW(10),GREEN(30);
	private final int seconds;
    //constructor
	private TrafficLight(int seconds) {
		this.seconds = seconds;
	}
	// getter method only because we use constructor to set values
...
public class EnumWithTrafficLights {
	...
	public static void main(String[] args) {
		...
		{  
			//values() method is used to access all the values inside the constants
